    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          aws_secretsmanager_secret.cloudfront_distribution_id.arn,
          aws_secretsmanager_secret.cloudfront_domain.arn,
          aws_secretsmanager_secret.cloudfront_key_pair_id.arn,
...
resource "aws_iam_role_policy" "ecs_task_s3_cloudfront" {
  name = "${var.project_name}-ecs-task-s3-cloudfront"
